...
import bakery_image from "./biscuits.jpg";
...
import vegetables_new from "./vegetables_new.jpg";
import spices_new from "./spices_new.jpg";
import sauces_new from "./sauces_new.jpg";
import dry_fruits_new from "./dry_fruits_new.jpg";
import immunity_booster from "./immunity_booster.jpg";
import aloo_bhujia from "./aloo_bhujia.jpg";
import body_lotion from "./body_lotion.jpg";
import chips_image from "./chips.jpg";
import chocolate_image from "./chocolate.jpg";
import biscuits_image from "./biscuits.jpg";
import grains_new_image from "./grain_image.jpg";
import bottles_new_image from "./bottles_image.jpg";
...
export const categories = [
  ...
  {
    text: "Cold drinks and juice",
    path: "Drinks",
    image: bottles_new_image,
    bgColor: "#E1F5EC",
  },
  {
  ...
  {
    text: "Atta, rice and daal",
    path: "Grains",
    image: grains_new_image,
    bgColor: "#FFF3E0",
  },
  {
    text: "Chocolates and Sweets",
    path: "Sweets",
